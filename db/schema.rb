...
ActiveRecord::Schema.define(version: 2021_07_12_072304) do
  ...
  create_table "doctor_testimonials", force: :cascade do |t|
  ...
  create_table "faqs", force: :cascade do |t|
    ...
    t.datetime("created_at", precision: 6, null: false)
    t.datetime("updated_at", precision: 6, null: false)
    t.index(["code"], name: "index_faqs_on_code", unique: true)
  ...
  create_table "social_connects", force: :cascade do |t|
    ...
    t.datetime("created_at", precision: 6, null: false)
    t.datetime("updated_at", precision: 6, null: false)
    t.index(["user_id"], name: "index_social_connects_on_user_id")
  end
...
unique: true)
  ...
  add_foreign_key "social_connects", "users"
