...
export default class extends Controller {
  ...
  doctorDegree() {
    var that = this;
    const url = '/provider/data/degree.json';
  ...
  holistic() {
    var that = this;
    const url = '/provider/data/holistic_medicine.json';
  ...
  aditionalService() {
    var that = this;
    const url = '/provider/data/services.json';
  ...
  language() {
    var that = this;
    const url = '/provider/data/languages.json';
