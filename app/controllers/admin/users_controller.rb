module Admin
  class UsersController < Admin::BaseController
    ...
    def user_params(password = true)
      if password
        params.require(:user).permit(:full_name, :email, :image, :password, :password_confirmation, :title, :about)
      else
        params.require(:user).permit(:full_name, :email, :image, :title, :about)
      end
    end
  end
end
